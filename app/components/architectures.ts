...
export const AWS_SAAS: Architecture = {
  ...
  nodes: {
    ...
    far1:  { id: "far1", x: 530, y: 80, label: "ECS · cell-a", sub: "Fargate · m7g", kind: "k8s" },
    far2:  { id: "far2", x: 530, y: 180, label: "ECS · cell-b", sub: "Fargate · m7g", kind: "k8s" },
    sqs:   { id: "sqs", x: 530, y: 280, label: "SQS · EventBridge", sub: "events · DLQ", kind: "k8s" },
    cd:    { id: "cd", x: 530, y: 380, label: "CodePipeline", sub: "GitOps · canary", kind: "gitops" },
    ...
    sec2:  { id: "sec2", x: 300, y: 460, label: "WAF · Shield", sub: "OWASP · DDoS", kind: "sec" },
...
export const GCP_BANK: Architecture = {
  ...
  nodes: {
    ...
    gke1:  { id: "gke1", x: 530, y: 80, label: "GKE · us-central1", sub: "Anthos · Confidential", kind: "k8s" },
    gke2:  { id: "gke2", x: 530, y: 180, label: "GKE · us-east1", sub: "Anthos · Confidential", kind: "k8s" },
    ...
    fire:  { id: "fire", x: 760, y: 280, label: "Firestore", sub: "ledger · audit", kind: "data" },
...
export const AZURE_DATA: Architecture = {
  ...
  zones: [
    ...
    { ...Z.platform, label: "PLATFORM · AKS · serverless", kind: "k8s" },
  ...
  nodes: {
    ...
    cosmos:{ id: "cosmos", x: 760, y: 180, label: "Cosmos DB", sub: "multi-master · vCore", kind: "data" },
...
export const ONPREM_HYBRID: Architecture = {
  ...
  nodes: {
    ...
    kafka: { id: "kafka", x: 760, y: 380, label: "Kafka MSK-self", sub: "3 brokers · MM2", kind: "data" },
